    ...
    private static class Paint0s0 {
        public static void paint(VectorGraphics[] vg) {
            ...
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            100.0, 30.0, 3, 0);
            vg[1]
                    .drawString(
                            new TagString(
            ...
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            100.0, 270.0, 3, 0, true, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            300.0, 270.0, 2, 0, true, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            500.0, 270.0, 1, 0, true, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            100.0, 330.0, 3, 1, false, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            300.0, 330.0, 2, 1, false, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            500.0, 330.0, 1, 1, false, new Color(0, 255, 255,
                                    255), 2.0, true, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            100.0, 390.0, 3, 2, true, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            300.0, 390.0, 2, 2, true, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            500.0, 390.0, 1, 2, true, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            100.0, 450.0, 3, 3, false, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            300.0, 450.0, 2, 3, false, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1]
                    .drawString(
                            new TagString(
                                    "&lt;Vector<sup><b>\\Graphics%</b></sup> &amp; Card<i><sub>)Adapter)</sub></i>&gt;"),
                            500.0, 450.0, 1, 3, false, new Color(0, 255, 255,
                                    255), 2.0, false, new Color(0, 0, 0, 255));
            vg[1].dispose();
        } // paint
    } // class Paint0s0
