...
public class TestPaint extends TestingPanel {
    ...
    private static class Paint0s0 {
        public static void paint(VectorGraphics[] vg) {
            ...
            vg[1].setPaint(new GradientPaint(new Point2D.Double(0.0, 400.0),
                    new Color(255, 0, 0, 255),
                    new Point2D.Double(180.0, 580.0),
                    new Color(0, 0, 255, 255), false));
            vg[1].fillRect(0.0, 400.0, 180.0, 180.0);
            vg[1].setPaint(new GradientPaint(new Point2D.Double(250.0, 450.0),
                    new Color(0, 255, 0, 255),
                    new Point2D.Double(320.0, 520.0), new Color(255, 0, 255,
                            255), false));
            vg[1].fillRect(200.0, 400.0, 180.0, 180.0);
            vg[1].setPaint(new GradientPaint(new Point2D.Double(400.0, 400.0),
                    new Color(255, 0, 0, 255),
                    new Point2D.Double(440.0, 440.0), new Color(255, 255, 0,
                            255), true));
            vg[1].fillRect(400.0, 400.0, 180.0, 180.0);
            vg[2] = (VectorGraphics) vg[1].create();
            vg[2].shear(0.5, 0.5);
            vg[2].setPaint(new GradientPaint(new Point2D.Double(0.0, 0.0),
                    new Color(255, 0, 0, 255),
                    new Point2D.Double(120.0, 120.0),
                    new Color(0, 0, 255, 255), false));
            vg[2].fillRect(0.0, 0.0, 120.0, 120.0);
            vg[2].setPaint(new TexturePaint((BufferedImage) new BufferedImage(
                    32, 32, BufferedImage.TYPE_INT_ARGB),
                    new Rectangle2D.Double(0.0, 0.0, 32.0, 32.0)));
