...
public class TestTransforms extends TestingPanel {
    ...
    private static class Paint0s0 {
        public static void paint(VectorGraphics[] vg) {
            ...
            vg[3].fill(new JAVAGeneralPath(1,
                    new JAVAGeneralPath.PathElement[] {
                            new JAVAGeneralPath.MoveTo(0.0f, 0.0f),
                            new JAVAGeneralPath.LineTo(25.0f, 50.0f),
                            new JAVAGeneralPath.LineTo(-25.0f, 50.0f),
            ...
            vg[4].scale(2.0, 0.5);
            vg[4].fillAndDraw(new JAVAGeneralPath(1,
                    new JAVAGeneralPath.PathElement[] {
                            new JAVAGeneralPath.MoveTo(0.0f, 0.0f),
                            new JAVAGeneralPath.LineTo(25.0f, 50.0f),
                            new JAVAGeneralPath.LineTo(-25.0f, 50.0f),
                            new JAVAGeneralPath.LineTo(25.0f, -50.0f),
                            new JAVAGeneralPath.LineTo(-25.0f, -50.0f),
                            new JAVAGeneralPath.ClosePath() }), new Color(255,
                    0, 0, 255));
            vg[4].dispose();
            ...
            vg[9]
                    .transform(new AffineTransform(0.5, 1.0, 0.0, 2.0, 50.0,
                            -50.0));
            vg[9].draw(new JAVAGeneralPath(1,
                    new JAVAGeneralPath.PathElement[] {
                            ...
                            new JAVAGeneralPath.ClosePath() }));
            vg[9].dispose();
            vg[1].setTransform(new AffineTransform(1.0, 0.0, 0.0, 1.0, 400.0,
                    400.0));
