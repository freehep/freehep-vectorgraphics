 ...
 * @version $Id: freehep-graphicsio/src/main/java/org/freehep/graphicsio/font/FontTable.java 5641ca92a537 2005/11/26 00:15:35 duns $
 */
public abstract class FontTable {
    ...
    public String fontReference(Font font, boolean embed, String embedAs) {
        ...
        String key = font.getName() + (font.isBold() ? "[bold]" : "")
