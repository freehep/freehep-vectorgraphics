...
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-emf/target/freehep-graphicsio-emf-${V}.jar
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-java/target/freehep-graphicsio-java-${V}.jar
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-pdf/target/freehep-graphicsio-pdf-${V}.jar
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-ps/target/freehep-graphicsio-ps-${V}.jar
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-svg/target/freehep-graphicsio-svg-${V}.jar
export CLASSPATH=${CLASSPATH}:${VG}/freehep-graphicsio-swf/target/freehep-graphicsio-swf-${V}.jar
